...
const ClosingReport = ({navigation}) => {
...
//    const data = bestSellingGraphDate.report;
 ...
 console.log('token', token)
    fetch(`${SERVER_URL}api/report/closing`, {
      method: 'POST',
      headers: {
   ...
   const renderItem = ({ item }) => {
    ...
    {/* <Text style={{color: 'grey', fontSize: 12}}>Rs{item.price}</Text> */}
     ...
     <View style={styles.hbr}>
      ...
      <View style={styles.mainDiv}>
        <Text style={{fontSize: 30, color:'#fff', fontWeight: 'bold', textAlign:'center', textAlignVertical: 'center'}}>Closing Report</Text>
     
      </View>
      </ImageBackground>

      <View style={{height: '15%', backgroundColor: '#2a62ff', width:'95%', alignSelf:'center', marginTop: 10, borderRadius: 10, elevation: 5}}>
    ...
    <View style={styles.rightContainer}>
          ...
          <FlatList
           style={styles.scrol}
           data={data !== undefined ? data.pos[0].details: [{brand : 'no item', model : 'please see other day'}]}
